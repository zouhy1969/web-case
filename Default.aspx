<%@ Page Title="主页" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="_Default" %>
    ...
    <section class="featured">
        <div class="content-wrapper">
            ...
            <p>
                ...
                如果你对 ASP.NET 有任何疑问，请访问<a href="http://forums.asp.net/18.aspx" title="ASP.NET Forum">我们的论坛</a>。
            </p>
        </div>
    </section>
</asp:Content>
